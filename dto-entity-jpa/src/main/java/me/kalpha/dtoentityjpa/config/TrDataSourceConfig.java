...
@EnableJpaRepositories(
        ...
        basePackages = {"me.kalpha.dtoentityjpa.tr.repository"}//repositories
)
...
public class TrDataSourceConfig {
    ...
    @Bean
    @ConfigurationProperties("app.datasource.tr.configuration")
    public DataSource trDataSource() {
    ...
    public LocalContainerEntityManagerFactoryBean trEntityManagerFactory(EntityManagerFactoryBuilder builder) {
        ...
        return builder
                ...
                .packages("me.kalpha.dtoentityjpa.tr.entity")//entities
                .build();
    }
    @Primary
    @Bean
